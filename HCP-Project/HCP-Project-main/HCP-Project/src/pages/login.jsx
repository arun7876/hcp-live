...
function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-100">
      ...
      <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 shadow-lg rounded-md bg-white">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div>
              ...
              <input
                ...
                disabled={loading}
                className="w-full text-sm border-b border-slate-300 focus:border-blue-600 py-3 outline-none"
              />
            </div>
